...
async function startSending(ws) { // We need to wrap the loop into an async function for this to work
    while(ws.isAlive) {
      console.log('sending');
      ws.send(JSON.stringify({ color: materialColor(), name: fruit(), weight: getRandomFloat(10) }));
